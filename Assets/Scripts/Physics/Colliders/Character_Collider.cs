...
public class Character_Collider : MonoBehaviour
{
    ...
    void Start()
    {
      ...
      //new Vector3(-2, 8.5f, 1f) / scale, new Vector3(2, 8.5f, 1f)/ scale,
      //new Vector3(-2, 0, 1f)/ scale, new Vector3(2, 0, 1f)/ scale,
      //new Vector3(0, 1, 0), transform.gameObject);
//
      ////Back Face
      //faces[1] = new Face(transform.parent.position + new Vector3(0, 0f, 0),
      //new Vector3(-2, 8.5f, -2f)/ scale, new Vector3(2, 8.5f, -2f)/ scale,
      //new Vector3(-2, 0, -2f)/ scale, new Vector3(2, 0, -2f)/ scale,
      //new Vector3(0, 1, 0), transform.gameObject);
...
//
      ...
      //new Vector3(-2, 8.5f, 1f)/ scale, new Vector3(-2, 8.5f, -2f)/ scale,
      //new Vector3(-2, 0, 1f)/ scale, new Vector3(-2, 0, -2f)/ scale,
      //new Vector3(0, 1, 0), transform.gameObject);
